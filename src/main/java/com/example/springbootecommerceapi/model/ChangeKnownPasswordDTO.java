...
public class ChangeKnownPasswordDTO {
    ...
    public ChangeKnownPasswordDTO() {
    }

    public ChangeKnownPasswordDTO(String email, String oldPassword, String newPassword) {
        this.email = email;
    ...
    public boolean equals(Object o) {
        ...
        ChangeKnownPasswordDTO that = (ChangeKnownPasswordDTO) o;
